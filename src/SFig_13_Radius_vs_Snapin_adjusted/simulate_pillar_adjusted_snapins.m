function simulate_pillar_adjusted_snapins
...
save('../../output/pillar_adjusted_snapin_simulations.mat','sim_pillar_radius','sim_pillar_snapin','sim_results','a','gamma');
